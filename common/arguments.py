...
def parse_args():
    ...
    parser.add_argument('-root', '--root_dataset', default="/data2/cuimengmeng/processed_h36m/", type=str, metavar='PATH',
                        help='root data dir')
    ...
    parser.add_argument('-b', '--batch-size', default=260, type=int, metavar='N',
                        help='batch size in terms of predicted frames')
    parser.add_argument('-b_test', '--batch-size-test', default=260, type=int, metavar='N',
                        help='batch size in terms of tested frames')
    ...
    parser.add_argument('-lrd1', '--lr-decay_rate1', default=0.95, type=float)
    parser.add_argument('-lrd', '--lr-decay_rate', default=0.5, type=float, metavar='LR',
                        help='learning rate decay per epoch')
    parser.add_argument('-decayep', '--epoch-decay', default=80, type=int, metavar='EPOCH',
                        help='epoch decay')
